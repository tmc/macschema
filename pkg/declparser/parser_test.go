...
func TestParser_Parse(t *testing.T) {
	tests := []struct {
		...
		{
			name: "instance method taking a block argument",
			input: `- (void)beginSheet:(NSWindow *)sheetWindow 
		...
		{
			name:  "property declared as const",
			input: `@property(readonly) const void *eventRef;`,
			want: &Statement{
				Property: &PropertyDecl{
					Name:     "eventRef",
					Readonly: true,
		...
		{
			name:  "property with parameterized type",
			input: `@property(weak) id<NSWindowDelegate> delegate;`,
			want: &Statement{
				Property: &PropertyDecl{
					Name: "delegate",
					Weak: true,
		...
		{
			name:  "property with nullable, readonly, and strong pointer type",
			input: `@property(nullable, readonly, strong) NSScreen *screen;`,
			want: &Statement{
				Property: &PropertyDecl{
					Name:     "screen",
					Weak:     false,
